<footer class="bg-blue-900 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li class="flex items-start">
                        ...
                        <span>Jl. Pendidikan No. 123, Kota Nusantara</span>
                    </li>
                    <li class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('majors') }}" class="hover:text-blue-200">Jurusan</a></li>
                    <li><a href="{{ route('staff') }}" class="hover:text-blue-200">Staff & Guru</a></li>
                    <li><a href="{{ route('blog') }}" class="hover:text-blue-200">Berita</a></li>
                    <li><a href="{{ route('gallery') }}" class="hover:text-blue-200">Galeri</a></li>
            ...
            <div>
                ...
                <div class="mt-6">
                    <h3 class="text-lg font-semibold mb-2">Pendaftaran Siswa Baru</h3>
                    <a href="{{ route('registration') }}" class="inline-block bg-white text-blue-900 px-4 py-2 rounded-md font-semibold hover:bg-blue-100 transition-colors">
                        Daftar Sekarang
                    </a>
                </div>
            </div>
        ...
        <div class="mt-8 pt-8 border-t border-blue-800 text-center">
            <p>&copy; {{ date('Y') }} SMK Nusantara. Hak Cipta Dilindungi.</p>
        </div>
    </div>
</footer> 